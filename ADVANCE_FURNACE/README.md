...
| `IGNITION.ic10` | Pulses Advanced Furnace ignition while either start control is on, stops when both are off, and colors the ignition display red/green from the start-control state. |
