...
| `IGNITION.ic10` | Turns Advanced Furnace ignition on when either start control is on, off when both are off, and colors the ignition display red/green from the start-control state. |
