...
| `IGNITION.ic10` | Activates Advanced Furnace ignition at or above 270 K while either start control is on, stops below 265 K or when both controls are off, and colors the ignition display red/green from the start-control state. |
