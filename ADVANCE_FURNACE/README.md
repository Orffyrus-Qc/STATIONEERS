...
| `IGNITION.ic10` | Activates the Advanced Furnace below 570 K with hysteresis, disables ignition when both start controls are off, and colors the ignition display red/green from the start-control state. |
